    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="name" placeholder="Nom" name="name" value="<?php //echo $name ?>">
                <label for="name"><strong>Adresse : </strong></label>
                <input type="text" class="form-control" id="adress" placeholder="Adresse" name="adress" value="<?php // echo $adress ?>">
            </div>           
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label for="name"><strong>Ville : </strong></label>
                <input type="text" class="form-control" id="city" placeholder="Ville" name="city" value="<?php // echo $city ?>">
                <label for="name"><strong>Code postal : </strong></label>
                <input type="text" class="form-control" id="zip" placeholder="Code postal" name="zip" value="<?php // echo $zip ?>">
                <label for="name"><strong>Pays : </strong></label>
                <input type="text" class="form-control" id="country" placeholder="Pays" name="country" value="<?php //echo $country ?>">
            </div>    
        </div>
    </div>
    <div class="row">
